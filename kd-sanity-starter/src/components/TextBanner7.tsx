const TextBanner7 = () => {
  return (
    <div className='text-black w-[1280px] h-[485px] px-4 py-[184px] justify-center items-center gap-12 inline-flex'>
